...
System::Void TRSPUAVC::Main_Screen::Select_Units_Click(System::Object^ sender, System::EventArgs^ e)
{
...
System::Void TRSPUAVC::Main_Screen::activate_squad_button_Click(System::Object^ sender, System::EventArgs^ e)
{
    active_squad_list->Items->Clear();
    string name = to_string(active_squads_list->Items->Count + 1);
    name += " отряд";
    active_squads_list->Items->Add(gcnew String(name.c_str()));
}

System::Void TRSPUAVC::Main_Screen::load_data_Click(System::Object^ sender, System::EventArgs^ e)
{
    string empty = " ";
